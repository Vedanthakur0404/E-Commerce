...
export default function ProductList() {
  ...
  useEffect(()=>{
    dispatch(fetchAllProductsAsync()); // Call the action creator function
  ...
  const filters = [
   ...
   const handleFilter = async(e, section, option) => {
    ...
    if (e.target.checked){
      ...
      console.log('---------------- ',temp_category_list)
    ...
    if(categoriesList.length != 0){
     dispatch(fetchByCategoriesAsync(categoriesList))
    }
            ...
            <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
              <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                ...
                { products.map((product) => (
                  ...
                  <Link to="/product-detail" key={product._id}>
                    ...
                    <div key={product.id} className="group relative border-solid border-2 border-gray-200 p-2">
                      ...
                      <div className="mt-4 flex justify-between">
                        <div>
                          ...
                          <StarIcon className="h-5 w-5 inline mr-2" aria-hidden="true" />
